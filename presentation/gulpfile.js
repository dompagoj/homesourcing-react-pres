...
gulp.task('css-custom', () => gulp.src(['css/custom.scss']).pipe(compileSass()).pipe(gulp.dest('./dist')))
...
gulp.task('serve', () => {
  ...
  gulp.watch(['css/*.scss', 'css/print/*.{sass,scss,css}'], gulp.series('css-core', 'css-custom', 'reload'))
